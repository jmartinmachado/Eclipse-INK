...
<p class="Texto_2 BOX_Modulo_TiT">Eclipse</p>
<?
if(!isset($pagina)){
$pagina=0;
}
...
$const=10*3;
$i=1;
$todo_array=ObtenerEclipse($pagina);
$LS=count($todo_array);
...
if ($pagina>0){
$todo.="<a class='Link_2' href='trabajos.php?pagina=".($pagina-1)."' title='Siguiente (m&aacute;s nuevo)'><b>[ << Siguiente ]</b></a>";
}
if ($const<$LS&&$pagina>0){
$todo.="&nbsp&nbsp|&nbsp&nbsp";
}
if ($const<$LS){
$todo.="<a class='Link_2' href='trabajos.php?pagina=".($pagina+1)."' title='Anterior (m&aacute;s viejo)'><b>[ Anterior >> ]</b></a>";
}
$todo.="</div>";
echo $todo;
?>
