...
<p class="Texto_2 BOX_Modulo_TiT">Categorias</p>
<ul >
...
<p class="Texto_2 BOX_Modulo_TiT">Ejemplos</p>
<?
if(!isset($pagina)){
$pagina=0;
}
...
$const=10*3;
$i=1;
$todo_array=ObtenerPost($tipo,$pagina);
$LS=count($todo_array);
...
if ($pagina>0){
	if (($pagina-1)==0){
		$todo.="<a class='Link_2' href='".traducir_url("ejemplo.php")."?tipo=".$tipo."' title='Siguiente (m&aacute;s nuevo)'><b>[ << Siguiente ]</b></a>";
	}else{
		$todo.="<a class='Link_2' href='".traducir_url("ejemplo.php?pagina=".($pagina-1))."&tipo=".$tipo."' title='Siguiente (m&aacute;s nuevo)'><b>[ << Siguiente ]</b></a>";
	}
}
...
if ($const<$LS){
$todo.="<a class='Link_2' href='".traducir_url("ejemplo.php?pagina=".($pagina+1))."&tipo=".$tipo."' title='Anterior (m&aacute;s viejo)'><b>[ Anterior >> ]</b></a>";
}
$todo.="</div>";
echo $todo;
?>
