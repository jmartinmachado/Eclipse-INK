...
if ($pagina>0){
	if (($pagina-1)==0){
		$todo.="<a class='Link_2' href='".traducir_url("geek.php")."' title='Siguiente (m&aacute;s nuevo)'><b>[ << Siguiente ]</b></a>";
	}else{
		$todo.="<a class='Link_2' href='".traducir_url("geek.php?pagina=".($pagina-1))."' title='Siguiente (m&aacute;s nuevo)'><b>[ << Siguiente ]</b></a>";
	}
}
...
if ($const<$LS){
$todo.="<a class='Link_2' href='".traducir_url("geek.php?pagina=".($pagina+1))."' title='Anterior (m&aacute;s viejo)'><b>[ Anterior >> ]</b></a>";
}
$todo.="</div>";
echo $todo;
?>
