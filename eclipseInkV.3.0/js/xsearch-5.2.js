...
document.write("<table border=0 width=500 spacepadding='5' 'spacespacing=10' ><tr><td><span class='Texto_3'>"+records[rc].description+"</span></td></tr></table><span class='Link_1 Tm_9'>"+tmp+"</span><br><br>")
}
q2++
}
}
...
if (display_start>0) document.write("<a href='"+paramstring+"&disp="+(display_start-10)+"' class='Texto_3'>anterior</a>")
document.write("&nbsp;&nbsp;&nbsp;")
for (i=1; i<=pages; i+=1){
if ((((i-1)*10)+1)<=sites) document.write("<a href='"+paramstring+"&disp="+(((i-1)*10))+"' class='Texto_3'>"+i+"</a>&nbsp&nbsp ")
}
document.write("&nbsp;&nbsp;&nbsp;")
if (displast<=sites) document.write("<a href='"+paramstring+"&disp="+(displast)+"' class='Texto_3'>siguiente</a>")
