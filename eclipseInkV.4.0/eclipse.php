...
<?
	...
	$meta_Title="Eclipse INK - Eclipse";
?>
<? /*ииииииииииииииииииииииииииииииииии*/ ?>
		...
		<div id="ladob">
			<div class="cajaDerecha">
				...
				<? 
					...
					$hay_mas=Generar_Ultimos_Art($pagina,"resto","eclipse");
				?>
			<div class="paginacion">
				<?
					...
					if($pagina>0 || $hay_mas){
						...
						if ($pagina>0){
							if (($pagina-1)==0){
								$todo.="<a href='".traducir_url("eclipseink")."' class='textopaginacion' target='_self' title='' alt=''>л Anterior</a>";
							}else{
									$todo.="<a href='".traducir_url("eclipseink.pagina".($pagina-1))."' class='textopaginacion' target='_self' title='' alt=''>л Anterior</a>";
							}
						}
						if ($hay_mas&&$pagina>0){
						...
						if ($hay_mas){
							$todo.="<a href='".traducir_url("eclipseink.pagina".($pagina+1))."' class='textopaginacion' target='_self' title='' alt=''>Siguiente ╗</a></b>";
						}
