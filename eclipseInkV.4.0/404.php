...
$meta_Subject="www.EclipseInk.com.ar/404.php";
$meta_Title="Eclipse INK - Error 404";
?>
<? /*จจจจจจจจจจจจจจจจจจจจจจจจจจจจจจจจจจ*/ ?>
			...
			<div class="cajaDerecha">
				<div id="contenido" class="TextoContenido">
					<p align="center" class="Tm_25">
						<img src="<? echo IMG_Azar("404") ?>" border=0 alt="403" title="404">
						<br/>
						La pแgina que ha ingresado no existe o ha sido borrada del servidor
